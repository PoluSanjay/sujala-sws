...
import {
  ...
  MessageCircle, Sparkles, Star, CheckCircle2, HeadphonesIcon, Factory, Building2, Waves
} from "lucide-react";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium RO water purifiers, expert installation, AMC plans, and 24×7 repair service. Book online today." },
    ],
  }),
  component: HomePage,
});
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 md:px-6 md:py-24 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-xl text-lg text-muted-foreground">
              ...
              spare parts and expert service. Book in minutes — we handle the rest.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Button size="lg" asChild>
                <Link to="/products">Shop Purifiers <ArrowRight className="ml-1.5 h-4 w-4" /></Link>
              </Button>
              <Button size="lg" variant="outline" asChild>
                <Link to="/services">Book Service</Link>
              </Button>
              <Button size="lg" variant="ghost" asChild>
                <a href="tel:+919999999999"><Phone className="mr-1.5 h-4 w-4" /> Call Now</a>
              </Button>
            </div>
          ...
          <div className="relative flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
            <div>
              ...
              <p className="mt-2 max-w-xl text-white/85">
                Raise a complaint and we'll dispatch a certified technician. Track live status
                from your dashboard.
              </p>
            </div>
